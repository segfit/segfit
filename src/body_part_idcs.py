...
map2color_parts = np.vectorize(COLOR_MAP_PARTS.get)
colour2part = {value : key for key, value in COLOR_MAP_PARTS.items()}
...
num_smplx_vertices = 10475
SMPLX_2_BODY_PARTS = np.zeros(num_smplx_vertices)
for part_idx, vertex_idcs in BODY_PART_IDCS.items():
    for idx in vertex_idcs:
        SMPLX_2_BODY_PARTS[idx] = part_idx