#!/bin/bash
#SBATCH --job-name=vScanNet
#SBATCH --output=../../logs/vis_scannet_val_%A-%a.out
...
general.experiment_name="debug3_vis_scannet_val_query_${CURR_QUERY}_topk_${CURR_TOPK}_dbscan_${CURR_DBSCAN}" \
