#!/bin/bash
#SBATCH --job-name=S00_synthetic_baseline_85q
#SBATCH --output=../../logs/S00_synthetic_baseline_85q_%j.out
...
general.experiment_name="debug S00_synthetic_baseline_85q" \
...
general.checkpoint="/home/schult/projects/release/Mask3D/saved/S00_synthetic_baseline_85q/last.ckpt"
