#!/bin/bash
#SBATCH --job-name=S02_synthetic_baseline_170q
#SBATCH --output=../../logs/S02_synthetic_baseline_170q_%j.out
...
general.experiment_name="S02_synthetic_baseline_170q_fix" \
