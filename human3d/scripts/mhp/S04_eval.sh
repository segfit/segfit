...
general.experiment_name="debug_S04_eval" \
...
general.checkpoint="/home/schult/projects/release/Mask3D/saved/S04_egobody_synthetic_more_part_queries_fix/last.ckpt"
