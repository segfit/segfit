#!/bin/bash
#SBATCH --job-name=PES06_fixed_chirality
#SBATCH --output=../../../logs/PES06_fixed_chirality_%j.out
...
general.experiment_name="PES06_fixed_chirality_2" \
general.project_name="body_part_instance_segmentation" \
data/datasets=egobody_plus_synthetic.yaml \
