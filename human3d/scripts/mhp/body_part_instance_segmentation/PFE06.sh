#!/bin/bash
#SBATCH --job-name=PFE06
#SBATCH --output=../../../logs/PFE06_%j.out
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/body_part/PE06.ckpt"
