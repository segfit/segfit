#!/bin/bash
#SBATCH --job-name=PFSK06
#SBATCH --output=../../../logs/PFSK06_%j.out
...
general.experiment_name="PFSK06_2" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/body_part/PSK06.ckpt"
