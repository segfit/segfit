#!/bin/bash
#SBATCH --job-name=HFB06_after_iccv
#SBATCH --output=../../../logs/HFB06_after_iccv_%j.out
...
general.experiment_name="HFB06_after_iccv" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/human_instance/HB06.ckpt"
