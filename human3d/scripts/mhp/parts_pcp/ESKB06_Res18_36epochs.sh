...
#SBATCH --mem=80GB
#SBATCH --job-name=ESKB06_Res18_36epochs
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/ESKB06_Res18_36epochs_%j.txt
...
general.experiment_name="ESKB06_Res18_36epochs_2" \
general.project_name="multi_human_parsing" \
data/datasets=egobody_plus_synthetic_kinect_behave \
