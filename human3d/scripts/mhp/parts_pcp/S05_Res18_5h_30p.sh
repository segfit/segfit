#!/bin/bash
#SBATCH --job-name=S05_Res18_5h_30p
#SBATCH --output=../../../logs/S05_Res18_5h_30p_%j.out
...
#SBATCH --partition=bosch

export OMP_NUM_THREADS=3  # speeds up MinkowskiEngine

cd ../../../
python main_instance_segmentation.py \
general.experiment_name="S05_Res18_5h_30p_fix" \
...
model.num_parts_per_human_queries=30 \
