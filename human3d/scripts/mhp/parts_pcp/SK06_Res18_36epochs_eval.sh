...
#SBATCH --mem=80GB
#SBATCH --job-name=eSK06_Res18_36epochs
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/eval_syn_SK06_Res18_36epochs_%j.txt
...
general.experiment_name="eval_SK06_Res18_36epochs_2" \
general.project_name="multi_human_parsing" \
data/datasets=synthetic_kinect_only \
...
general.checkpoint="/home/js411977/code/Mask3D_dev/saved/SK06_Res18_36epochs_2/last.ckpt" \
