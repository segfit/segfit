#!/bin/bash
#SBATCH --job-name=ESB06_Res18_36epochs
#SBATCH --output=../../../logs/ESB06_Res18_36epochs_%j.out
...
general.experiment_name="ESB06_Res18_36epochs" \
general.project_name="multi_human_parsing" \
data/datasets=egobody_plus_synthetic_behave \
