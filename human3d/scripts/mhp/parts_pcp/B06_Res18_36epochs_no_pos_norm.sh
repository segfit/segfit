...
#SBATCH --mem=80GB
#SBATCH --job-name=B06_Res18_36epochs_no_pos_norm
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/B06_Res18_36epochs_no_pos_norm_%j.txt
...
python main_instance_segmentation.py \
  general.experiment_name="B06_Res18_36epochs_no_pos_norm" \
