#!/bin/bash
#SBATCH --job-name=HFS06_no_mirroring
#SBATCH --output=../../../logs/HFS06_no_mirroring_%j.out
...
general.experiment_name="HFS06_no_mirroring_3" \
...
general.checkpoint="/home/schult/projects/release/Mask3D/saved/HS06_no_mirroring/last.ckpt"
