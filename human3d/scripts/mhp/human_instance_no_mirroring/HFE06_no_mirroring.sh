...
#SBATCH --account=rwth1238
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=80GB
#SBATCH --job-name=HFE06_no_mirroring
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/HFE06_no_mirroring_%j.txt
...
general.experiment_name="HFE06_no_mirroring_2" \
...
general.checkpoint="/home/js411977/code/Mask3D_dev/saved/HE06_no_mirroring/last.ckpt"
