#!/bin/bash
#SBATCH --job-name=HFSK06_no_mirroring_2
#SBATCH --output=../../../logs/HFSK06_no_mirroring_2_%j.out
...
general.experiment_name="HFSK06_no_mirroring_2" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/human_instance_no_mirroring/HSK06_no_mirroring.ckpt"
