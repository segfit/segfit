#!/bin/bash
#SBATCH --job-name=FSK06_no_mirroring
#SBATCH --output=../../../logs/FSK06_no_mirroring_%j.out
...
general.experiment_name="FSK06_no_mirroring_2" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp_no_mirroring/SK06_no_mirroring.ckpt"
