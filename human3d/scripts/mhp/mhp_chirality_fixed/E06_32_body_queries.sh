#!/bin/bash
#SBATCH --job-name=E06_32_body_queries
#SBATCH --output=../../../logs/E06_32_body_queries_%j.out
...
general.experiment_name="E06_32_body_queries" \
...
model.num_parts_per_human_queries=32 \
