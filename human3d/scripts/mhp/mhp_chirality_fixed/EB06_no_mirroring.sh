#!/bin/bash
#SBATCH --job-name=EB06_no_mirroring
#SBATCH --output=../../../logs/EB06_no_mirroring_%j.out
...
general.experiment_name="EB06_no_mirroring" \
general.project_name="multi_human_parsing" \
data/datasets=egobody_plus_behave \
