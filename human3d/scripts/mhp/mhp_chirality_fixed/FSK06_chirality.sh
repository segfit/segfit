#!/bin/bash
#SBATCH --job-name=FSK06_chirality
#SBATCH --output=../../../logs/FSK06_chirality_%j.out
...
general.experiment_name="FSK06_chirality" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp_chirality/SK06_chirality.ckpt"
