#!/bin/bash
#SBATCH --job-name=FE06_no_mirroring
#SBATCH --output=../../../logs/FE06_no_mirroring_%j.out
...
general.experiment_name="FE06_no_mirroring" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp_no_mirroring/E06_no_mirroring.ckpt"
