#!/bin/bash
#SBATCH --job-name=FS06_no_mirroring
#SBATCH --output=../../../logs/FS06_no_mirroring_%j.out
...
general.experiment_name="FS06_no_mirroring_2" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp_no_mirroring/S06_no_mirroring.ckpt"
