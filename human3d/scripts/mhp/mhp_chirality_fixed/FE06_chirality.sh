#!/bin/bash
#SBATCH --job-name=FE06_chirality
#SBATCH --output=../../../logs/FE06_chirality_%j.out
...
general.experiment_name="FE06_chirality_2" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp_chirality/E06_chirality.ckpt"
