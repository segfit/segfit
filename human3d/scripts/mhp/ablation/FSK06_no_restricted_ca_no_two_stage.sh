#!/bin/bash
#SBATCH --job-name=FSK06_no_restricted_ca_no_two_stage
#SBATCH --output=../../../logs/FSK06_no_restricted_ca_no_two_stage_%j.out
...
general.experiment_name="FSK06_no_restricted_ca_no_two_stage" \
...
#general.checkpoint="saved/SK06_no_restricted_ca_no_two_stage_2/last.ckpt"
