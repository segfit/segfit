#!/bin/bash
#SBATCH --job-name=FSK06_no_restricted_ca
#SBATCH --output=../../../logs/FSK06_no_restricted_ca_%j.out
...
general.experiment_name="FSK06_no_restricted_ca" \
...
general.checkpoint="saved/SK06_no_restricted_ca_2/last.ckpt"
