#!/bin/bash
#SBATCH --job-name=E06_no_restricted_ca_no_two_stage
#SBATCH --output=../../../logs/E06_no_restricted_ca_no_two_stage_%j.out
...
general.experiment_name="E06_no_restricted_ca_no_two_stage" \
