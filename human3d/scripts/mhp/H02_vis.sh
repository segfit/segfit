...
#SBATCH --mem=96GB
#SBATCH --job-name=H01_egobody_baseline_longer_85q
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../logs/H01_egobody_baseline_longer_85q_%j.txt
...
general.experiment_name="H01_egobody_baseline_longer_85q" \
