...
#SBATCH --mem=80GB
#SBATCH --job-name=HB06_Res18_36epochs_no_pos_norm
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/HB06_Res18_36epochs_no_pos_norm_%j.txt
...
general.experiment_name="HB06_Res18_36epochs_no_pos_norm" \
