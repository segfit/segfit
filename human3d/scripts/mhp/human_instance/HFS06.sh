#!/bin/bash
#SBATCH --job-name=HFS06iccv
#SBATCH --output=../../../logs/HFS06_iccv_%j.out
...
general.experiment_name="HFS06_iccv" \
...
general.checkpoint="/home/schult/projects/release/Mask3D/saved/HS06_2/last.ckpt"
