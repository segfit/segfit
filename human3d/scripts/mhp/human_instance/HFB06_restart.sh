...
#SBATCH --mem=80GB
#SBATCH --job-name=HFB06_restart
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/HFB06_restart_%j.txt
...
general.experiment_name="HFB06_restart" \
...
general.checkpoint="/home/js411977/code/Mask3D_dev/saved/HB06_restart/last.ckpt"
