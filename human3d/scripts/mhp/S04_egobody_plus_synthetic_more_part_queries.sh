#!/bin/bash
#SBATCH --job-name=S04_egobody_synthetic_more_part_queries
#SBATCH --output=../../logs/S04_egobody_synthetic_more_part_queries_%j.out
...
general.experiment_name="S04_egobody_synthetic_more_part_queries_fix" \
