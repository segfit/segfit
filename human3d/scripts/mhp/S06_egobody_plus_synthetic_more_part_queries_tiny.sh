#!/bin/bash
#SBATCH --job-name=S06_egobody_synthetic_more_part_queries_tiny
#SBATCH --output=../../logs/S06_egobody_synthetic_more_part_queries_tiny_%j.out
...
general.experiment_name="S06_egobody_synthetic_more_part_queries_tiny" \
