#!/bin/bash
#SBATCH --job-name=fB06_broken_mirroring
#SBATCH --output=../../../logs/fB06_broken_mirroring_%j.out
...
general.experiment_name="fB06_broken_mirroring" \
...
general.checkpoint="/globalwork/schult/B06_Res18_36epochs_2.ckpt" \
