#!/bin/bash
#SBATCH --job-name=fE06_broken_mirroring
#SBATCH --output=../../../logs/fE06_broken_mirroring_%j.out
...
general.experiment_name="fE06_broken_mirroring" \
...
general.checkpoint="/globalwork/schult/E06_Res18_36epochs_best.ckpt" \
data.broken_mirror_version=true
