...
#SBATCH --mem=80GB
#SBATCH --job-name=fSK06_lr10_5_reverse
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/fSK06_lr10_5_reverse_%j.txt
...
general.experiment_name="fSK06_lr10_5_reverse" \
...
general.checkpoint="saved/E06_Res18_36epochs/last.ckpt" \
