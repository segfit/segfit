#!/bin/bash
#SBATCH --job-name=FS06iccv
#SBATCH --output=../../../logs/FS06iccv_%j.out
...
general.experiment_name="FS06_iccv" \
...
general.checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp/S06.ckpt"
