...
#SBATCH --mem=80GB
#SBATCH --job-name=fB06_lr10_5
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/fB06_lr10_5_%j.txt
...
general.experiment_name="fB06_lr10_5" \
...
general.checkpoint="saved/B06_Res18_36epochs_2/last.ckpt" \
