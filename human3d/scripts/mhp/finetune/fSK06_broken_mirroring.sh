...
#SBATCH --mem=80GB
#SBATCH --job-name=fSK06_broken_mirroring
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../../logs/fSK06_broken_mirroring_%j.txt
...
general.experiment_name="fSK06_broken_mirroring" \
...
general.checkpoint="saved/SK06_Res18_36epochs_2/last.ckpt" \
