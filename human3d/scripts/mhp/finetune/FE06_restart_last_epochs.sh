#!/bin/bash
#SBATCH --job-name=FE06_restart
#SBATCH --output=../../../logs/FE06_restart_%j.out
...
general.experiment_name="FE06_restart_last_epochs_2" \
...
trainer.resume_from_checkpoint="/globalwork/schult/humanseg_final_ckpts/mhp/FE06_ep31.ckpt"
