...
#SBATCH --output=../../logs/17_eval_stpls3d_dbscan_%A-%a.txt
#SBATCH --array=1-3
...
general.experiment_name="17_stpls3d_eps_${CURR_DBSCAN}_cropsize_${CURR_SIZE}_query_${CURR_QUERY}_topk_${CURR_TOPK}_fix" \
