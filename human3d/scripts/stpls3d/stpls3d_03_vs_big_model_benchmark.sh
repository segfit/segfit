...
#SBATCH --mem=96GB
#SBATCH --job-name=bbm_val_stpls3d_03_vs
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../logs/benchmark_stpls3d_03_vs_big_model_%j.txt
...
general.experiment_name="stpls3d_val_03_vs_big_model_benchmark" \
