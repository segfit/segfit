...
#SBATCH --mem=96GB
#SBATCH --job-name=benchmark_stpls3d_17_54m
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../logs/benchmark_stpls3d_17_54m_%j.txt
...
general.experiment_name="stpls3d_benchmark_54m" \
