...
#SBATCH --mem=96GB
#SBATCH --job-name=val_stpls3d_17_color_drop
#SBATCH --time=5-00:00:00
#SBATCH --signal=TERM@120
#SBATCH --mail-user=schult@vision.rwth-aachen.de
#SBATCH --mail-type=ALL
#SBATCH --output=../../logs/val_stpls3d_17_color_drop_%j.txt
...
general.experiment_name="stpls3d_val_color_drop" \
...
data.train_dataset.color_drop=0.2
