...
def make_pred_info(pred: dict):
    # pred = {'pred_human_scores' = 100, 'pred_human_classes' = 100 'pred_human_masks' = Nx100}
    pred_info = {}
    assert (pred['pred_human_classes'].shape[0] == pred['pred_human_scores'].shape[0] == pred['pred_human_masks'].shape[1])
