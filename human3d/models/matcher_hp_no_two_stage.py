...
class HungarianMatcherHumanPartsNoTwoStage(nn.Module):
    ...
    def __init__(self,
                 cost_human_class: float = 1,
                 cost_part_class: float = 1,
                 cost_mask: float = 1,
                 cost_dice: float = 1,
                 num_points: int = 0):
        """Creates the matcher
        ...
        """
        super().__init__()
        self.cost_human_class = cost_human_class
        self.cost_part_class = cost_part_class
