...
class SetCriterionHumanParts(nn.Module):
    ...
    def forward(self, outputs, targets, mask_type):
        ...
        part_indices = self.matcher(human_parts_pred, human_parts_targets, mask_type)

        for loss in self.losses:
            l_dict = self.get_loss(loss, human_parts_pred, human_parts_targets, part_indices, num_masks, mask_type, parts=True)
        ...
        if "aux_outputs" in outputs:
            for i, aux_outputs in enumerate(outputs["aux_outputs"]):
                ...
                for loss in self.losses:
                    l_dict = self.get_loss(loss, human_parts_pred, human_parts_targets, part_indices, num_masks,
